...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            git_cmd::validate_patch_applies,
            ...
            git_cmd::get_repo_health,
            git_cmd::create_branch,
            git_cmd::switch_branch,
            git_cmd::delete_branch,
            git_cmd::list_head_reflog,
            git_cmd::get_log,
            git_cmd::get_log_range,
            git_cmd::get_commit_diff,
            git_cmd::get_commit_diff_files,
            git_cmd::get_commit_file_diff,
            git_cmd::list_files,
            git_cmd::list_tree,
            git_cmd::get_file_history,
            git_cmd::get_file_blame,
            git_cmd::get_file_content,
            git_cmd::list_worktrees,
            git_cmd::add_worktree,
            git_cmd::remove_worktree,
            git_cmd::list_hooks,
            git_cmd::get_hook_content,
            git_cmd::save_hook_content,
            git_cmd::get_bisect_state,
            git_cmd::bisect_start,
            git_cmd::bisect_mark,
            git_cmd::bisect_reset,
            git_cmd::rewrite_history,
            // Git commands — remote
            ...
            ai_cmd::suggest_conflict_resolution,
            ai_cmd::suggest_conflict_resolution_stream,
